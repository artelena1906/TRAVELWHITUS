...
import styles from '../../PageTours/css/PageTours.module.css';
...
export default function MainPageSectionTourAll({ filters }: MainPageSectionTourProps) {
  ...
  return (
    <div className={styles.containerToursAll}>
      <h1 className={styles.title}>Календар турів</h1>

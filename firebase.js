...
// // Вмикаємо офлайн-підтримку (тільки в браузері, і лише один раз)
...
// Инициализация Firebase App один раз
const app = !getApps().length ? initializeApp(firebaseConfig) : getApp();

// Firestore: просто получаем уже инициализированный экземпляр
const db = getFirestore(app);
